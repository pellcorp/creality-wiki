...
!!! note
    ...
    If you have plugged your cartographer into the front usb port, you are going to have to temporarily remove the cartographer from the usb slot and replace it with your usb key, after you have finished verifying the usb key can be used in an emergency, you can replace the cartographer into the usb slot and restart klipper or power cycle your printer.
