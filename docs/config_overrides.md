...
- You can **only** add or delete values from **existing** sections in printer.cfg, grumpyscreen.ini and moonraker.conf, all other files these changes will be ignored.
- You can **only** add or delete sections in printer.cfg, moonraker.conf and grumpyscreen.ini, all other files these changes will be ignored.
