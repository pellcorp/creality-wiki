...
- **_SAF_LINE_PURGE** - A custom line purge macro which will be used instead of built in LINE_PURGE
- **_SAF_SMART_PARK** - A custom smart park macro which will be used instead of built in SMART_PARK
