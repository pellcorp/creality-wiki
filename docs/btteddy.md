...
!!! note
    ...
    If you have plugged your btt eddy into the front usb port, you are going to have to temporarily remove the btt eddy from the usb slot and replace it with your usb key, after you have finished verifying the usb key can be used in an emergency, you can replace the btt eddy into the usb slot and restart klipper or power cycle your printer.
