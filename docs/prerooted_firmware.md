...
constructed](https://github.com/pellcorp/creality-firmware/tree/main/ingenic) by taking the prerooted and decrypted rootfs from creating the img to construct the equivalent .ingenic 
images.
