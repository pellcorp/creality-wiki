...
Like for Simple AF, the installer will copy the `guppyscreen.ini` to the config directory so you can customise it and restart GrumpyScreen for changes to be applied. 
