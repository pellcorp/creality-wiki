...
The save config sections you will need to remove when switching **from** btteddy to any other probe are:
...
The save config sections you will need to remove when switching **from** cartotouch to any other probe are:
...
### Cleanup of cartographer

The save config sections you will need to remove when switching **from** cartographer to any other probe are:
