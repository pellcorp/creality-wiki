...
Before an emergency happens, you should verify you have a USB key that can be used perform a factory reset via [Verify USB for Factory Reset](verify_usb.md)
